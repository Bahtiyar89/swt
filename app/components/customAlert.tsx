...
import { Image, TouchableOpacity, Modal, StyleSheet, Text, Pressable, View, Platform } from "react-native";
...
interface IState { 
    ...
    onPressPositiveButton: (params: any) => void;
    onPressNegativeButton: (params: any) => void;
  }

const CustomAlert : React.FC<IState> = ({ 
    displayAlert,
    displayAlertIcon,
    alertTitleText,
    alertMessageText,
            ...
            <View style={styles.bottomPart}>
              {
                ...
                <TouchableOpacity
                  ...
                  <Text style={styles.alertMessageButtonTextStyle}>{positiveButtonText}</Text>
                </TouchableOpacity>
              }
              {
                displayNegativeButton
                ...
                <TouchableOpacity
                  ...
                  style={styles.alertMessageButtonStyle}>
                  <Text style={styles.alertMessageButtonTextStyle}>{negativeButtonText}</Text>
                </TouchableOpacity>
              }
            </View>
          </View>
